...
mapping (uint256 index_ mapping(uint256 companyHash_ => CompanyInfo companyInfo_)) _companies;
```
 ...
 * @return 成功または失敗と、作成された企業のアドレスです。
 */
...
```solidity
// -- 1.1 Error: Register/Invalid-Address -- //
/**
...
```mermaid
    sequenceDiagram
        ...
        BLC -->>- RTC: res: return execute success bool and new company address
        ...
        alt: new companyInfo add to companies
