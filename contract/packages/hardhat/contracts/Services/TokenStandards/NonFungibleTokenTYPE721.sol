...
import {EventNonFungibleTokenTYPE721} from "../interfaces/TokenService/TokenStandards/NonFungibleTokenTYPE721/EventNonFungibleTokenTYPE721.sol";
import {ErrorNonFungibleTokenTYPE721} from "../interfaces/TokenService/TokenStandards/NonFungibleTokenTYPE721/ErrorNonFungibleTokenTYPE721.sol";
    ...
    ErrorNonFungibleTokenTYPE721
{
    ...
    function tokenURI(
        ...
        return
            string(
                abi.encodePacked(
                    ERC721Upgradeable.tokenURI(tokenId_),
                    _baseExtension
                )
            );
    }
