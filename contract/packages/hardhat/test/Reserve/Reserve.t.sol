...
import {EventReserve} from "../../contracts/Reserve/interfaces/EventReserve.sol";
import {ErrorReserve} from "../../contracts/Reserve/interfaces/ErrorReserve.sol";
...
contract TestReserve is Test {
    ...
    function test_Fail_Reserve_reservation_ByAdmin() public {
        ...
        // 1. ホワイトリストに予約者アカウントが存在していないことを確認する
        assertFalse(rs.isWhitelisted(address(reserver)));
