...
contract SCInitialize {
    ...
    function initialize(address sc, address dictionary) public {
        ...
        // _registerDictionary(sc, dictionary);

        bytes4[] memory selectors = new bytes4[](6);
        selectors[0] = bytes4(keccak256("initialize(address,address)"));
        selectors[1] = bytes4(keccak256("registerService(uint8[],address[])"));
        selectors[2] = bytes4(
            keccak256("setInvestmentAmount(address,uint256)")
        );
        selectors[3] = bytes4(keccak256("getSCR()"));
    ...
    function _registerDictionary(address sc, address dictionary) internal {
