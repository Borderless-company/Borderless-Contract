...
library KIBOTCHA_LETS_JP_LLC_NON_EXEInitializeLib {
    event KIBOTCHA_LETS_JP_LLC_NON_EXEInitialized(address indexed initializer);
    ...
    function initialize(
        ...
        Dictionary(dictionary).setImplementation(
            bytes4(keccak256("reserveMint(address,uint256)")),
            implementation
        );
        emit KIBOTCHA_LETS_JP_LLC_NON_EXEInitialized(msg.sender);
    }
}
