...
contract TokenServiceFactory is IFactoryService, EventFactoryService {
...
contract TokenService is ITokenService {
    ...
    modifier onlyService() {
        require(_validateCaller(), "Error: TokenService/Invalid-Caller");
        _;
    }
